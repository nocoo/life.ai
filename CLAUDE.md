...
Version 1.4.0 was deployed on 2026-09-14, Worker version `53cc6dc5-d119-44f6-b70c-306a522ac317`. `docs/16-daily-context-and-record-tabs.md` records the hourly maps, raw-record tabs, public context, Basalt/Recharts views and verified release. The production dataset remains 670,191 GPS points in 1,625 UTC daily rows. `docs/15-data-management.md` retains the 1.3.0 release, complete production import, independent all-point verification and unchanged reimport. `docs/13-story-timeline.md` retains 1.2.0 timeline design/release evidence; `docs/12-daily-view.md` retains 1.1.0 daily views/AI evidence, and `docs/08-chronicle-rewrite.md` retains the original 1.0.0 rewrite and release evidence.
