...
Version 1.5.1 was deployed on 2026-09-14, Worker version `795724ab-d2ed-4879-b3e3-23cf3cd945b7`. `docs/18-daily-card-design.md` records the compact all-day layout, category colors/icons, supporting information panels, accessible motion and verified release checks. Both public health endpoints report 1.5.1 with D1 healthy. This release has no migrations or data imports.
